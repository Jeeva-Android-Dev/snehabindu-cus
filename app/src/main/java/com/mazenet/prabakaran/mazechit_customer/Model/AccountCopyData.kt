...
class AccountCopyData {
    ...
    @SerializedName("overall_received_amount")
    @Expose
    private var overallreceivedamount: String? = null
    ...
    fun AccountCopyData(
        ...
        this.status = status
        this.overallreceivedamount = overallreceivedamount
    ...
    fun getoverallReceivedAmount(): String?{
        return  overallreceivedamount
    }
    fun setoverallReceivedAmount(overallreceivedamount: String){
        this.overallreceivedamount= overallreceivedamount
    }
}