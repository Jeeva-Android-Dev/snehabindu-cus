...
//        }
                        ...
                        response.code().equals(200) -> {
                            ...
                            if (response.body()?.getStatus().equals("Signup")) {
                                ...
                                if (fingerprinted) {
                                    ...
                                    setPrefsString(Constants.CUST_PHNO,email).toString()
    ...
    fun loginfirst(context: Activity) {
        ...
        fingerprint_login_popup!!.contentView = layout
        fingerprint_login_popup!!.width = RelativeLayout.LayoutParams.MATCH_PARENT
        fingerprint_login_popup!!.height = RelativeLayout.LayoutParams.MATCH_PARENT
        fingerprint_login_popup!!.animationStyle = R.style.AnimationPopup
        fingerprint_login_popup!!.isFocusable = true
