...
class Fragment_Dashboard : BaseFragment(), BaseSliderView.OnSliderClickListener {
    ...
    override fun onCreateView(
        ...
        txt_welcome.text = "Hi "+getPrefsString(Constants.CUST_NAME,"" )
        ...
        view.layout_myoutstanding.setOnClickListener {
            doFragmentTransaction(MyOutstanding(), "myoutstanding", true, "", "")
        }
        view.layout_myprofile.setOnClickListener {
            doFragmentTransaction(MyProfile(), "myprofile", true, "", "")
        }
