...
class HomeActivity : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       //navView.menu.getItem()
        ...
        navigation_header_texts.txt_username.text = getPrefsString(Constants.CUST_NAME, "")
        navigation_header_texts.txt_usercode.text = getPrefsString(Constants.CUST_CODE, "")
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            com.mazenet.prabakaran.mazechit_customer.R.id.nav_share -> {
                showCustomShareDialog()

            }
            com.mazenet.prabakaran.mazechit_customer.R.id.nav_aboutus -> {
                replacefragment(AboutPage())
            }
            com.mazenet.prabakaran.mazechit_customer.R.id.nav_myprofile -> {
                replacefragment(MyProfile())
            }
            com.mazenet.prabakaran.mazechit_customer.R.id.nav_contactus -> {
    ...
    private fun showCustomShareDialog() {
        val builder = AlertDialog.Builder(this)
        val customLayout = layoutInflater.inflate(R.layout.custom_share_dailog, null)

        // Add your app logo and share message to the custom layout
    ...
    private fun shareApp() {
        ...
        shareMessage = """
           ${shareMessage}https://play.google.com/store/apps/details?id=com.mazenet.mm.snehabindu_chit_customer&pcampaignid=web_share
           """.trimIndent()
