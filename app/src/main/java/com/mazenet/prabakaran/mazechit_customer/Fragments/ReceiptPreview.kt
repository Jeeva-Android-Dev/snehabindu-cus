...
//                    view.txt_rp_isduplicate.visibility = View.VISIBLE
        ...
        view.txt_rp_date.text = arguments!!.getString("recptdate")
        view.txt_rp_cusname.text = arguments!!.getString("customername")
        view.txt_rp_custid.text = arguments!!.getString("customerid")
        view.txt_rp_cusmobile.text = arguments!!.getString("customermobile")
        view.txt_rp_grptktno.text = arguments!!.getString("groupname") + " / " + arguments!!.getString("ticketno") + " / " + arguments!!.getString(
            "installmentno"
        )
        view.txt_rp_totaamntdue.text = arguments!!.getString("totaldue")
        view.txt_rp_penaulty.text = arguments!!.getString("penalty")
        view.txt_rp_bonus.text = arguments!!.getString("bonus")
        view.txt_rp_receivedamnt.text = arguments!!.getString("receivedamount")
        val paytype = arguments!!.getString("paymentmode")
        view.txt_rp_preparedby.text = arguments!!.getString("username")
        view.txt_rp_paymentmode.text = paytype
        //change 1
        if (paytype.equals("Cheque")) {
            ...
            view.txt_rp_chequebank.text = arguments!!.getString("chequebank")
            ...
            view.transactionlayout.visibility = View.GONE
            view.txt_rp_ddbank.text = arguments!!.getString("chequebank")
            view.txt_rp_ddno.text = arguments!!.getString("chequeno")
            view.txt_rp_ddbranch.text = arguments!!.getString("chequebranch")
            view.txt_rp_dddate.text = arguments!!.getString("chequedate")
        } else if (paytype.equals("RTGS/NEFT") || paytype.equals("Card")) {
            view.chequelayout.visibility = View.GONE
            view.ddlayout.visibility = View.GONE
            view.transactionlayout.visibility = View.VISIBLE
            view.txt_rp_transaction_no.text = arguments!!.getString("transactionno")
            view.txt_rp_transactiondate.text = arguments!!.getString("transactiondate")
        } else {
            view.chequelayout.visibility = View.GONE
            view.ddlayout.visibility = View.GONE
            view.transactionlayout.visibility = View.GONE
        }
        view.txt_rp_tenantname.text = getPrefsString(Constants.TENANT_NAME, "")
        ...
        view.txt_rp_address.text = full_address.toString()
